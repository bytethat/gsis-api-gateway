...
public class Gsis39aImpl implements Gsis39a {
    ...
    public List<IdentityType> getIdentityTypes() {
        return List.of(
                new IdentityType("1", "ΑΣΤΥΝΟΜΙΚΗ ΤΑΥΤΟΤΗΤΑ"),
                new IdentityType("8", "ΔΙΑΒΑΤΗΡΙΟ"),
                new IdentityType("2", "ΕΛΛΗΝΙΚΟΣ ΣΤΡΑΤΟΣ"),
                new IdentityType("3", "ΠΟΛΕΜΙΚΟ ΝΑΥΤΙΚΟ"),
                new IdentityType("4", "ΠΟΛΕΜΙΚΗ ΑΕΡΟΠΟΡΙΑ"),
                new IdentityType("5", "ΕΛΛΗΝΙΚΗ ΑΣΤΥΝΟΜΙΑ"),
                new IdentityType("6", "ΛΙΜΕΝΙΚΟ ΣΩΜΑ"),
                new IdentityType("7", "ΠΥΡΟΣΒΕΣΤΙΚΟ ΣΩΜΑ"),
                new IdentityType("9", "ΚΕΝΤΡΟ ΑΛΛΟΔΑΠΩΝ"),
                new IdentityType("11", "ΕΝΤΟΛΕΑΣ ΦΠ"),
                new IdentityType("12", "ΚΑΡΤΑ ΠΑΡΑΜΟΝΗΣ ΠΕΡΙΟΡ ΧΡΟΝ ΔΙΑΡΚ"),
                ...
                new IdentityType("24", "ΕΛΛΗΝΙΚΗ ΑΓΡΟΦΥΛΑΚΗ"),
